...
public class GuiModOptions extends Screen implements Supplier<Screen> {
    ...
    protected void init() {
        ...
        for (String text: options) {
            ...
            if (value == null) {
                ...
                element = this.addButton(new AbstractButtonWidget(this.width/2+10, y, ((Boolean) value == true ? "§2true" : "§4false")) {
                    @Override
                    public void onClick(double x, double y) {
                ...
                element=this.addButton(new TextFieldWidget(this.font, this.width/2+10, y, 200, BUTTONHEIGHT, (String) value) {
                    @Override
                    public void onFocusedChanged(boolean b) {
                        if (b) {
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        renderBackground();
        drawCenteredString(font, screenTitle, this.width/2, BUTTONHEIGHT, 0xffffff);
